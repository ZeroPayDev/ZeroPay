...
pub enum ChainMessage {
    // chain_id, token_address, to_address, amount, block_number, tx_hash
    Deposit(usize, Address, Address, U256, u64, B256),
    NonceClear,
...
pub async fn run(
    ...
    for config in configs {
        ...
        evm::scan(chain_id, rpc.clone(), tokens, sender.clone(), redis.clone());
    ...
    loop {
        ...
        match work {
            Some(ChainMessage::Deposit(
                ...
                tracing::info!(
                    "Processing deposit: Chain {}, Token {}, To {}, Amount {}, Block {}, Tx {}",
                    chain_id,
                    token_address,
                    to_address,
                    amount,
